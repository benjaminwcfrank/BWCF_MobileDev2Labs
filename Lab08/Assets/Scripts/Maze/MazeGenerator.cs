...
public class MazeGenerator : MonoBehaviour
{
    ...
    {
        GameObject PlayerRef = Instantiate(playerPrefab, startTileRef.transform.position + new Vector3(0f, 5f, 0f), startTileRef.transform.rotation);
        //GetComponent<GameSaveManager>().player = PlayerRef.transform; //This is stupid but no time tonight
    }
